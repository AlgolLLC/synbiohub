...
var views = {
    ...
    group: require('./views/group'),
    createGroup: require('./views/createGroup'), 
    admin: {
        groups: require('./views/admin/groups'),
...
function App() {
    ...
    app.post('/createGroup', requireUser, views.createGroup);
    app.get('/createGroup', requireUser, views.createGroup);
    ...
    app.get('/groups/:groupId', requireUser, views.group)
